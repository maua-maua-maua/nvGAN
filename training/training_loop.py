...
def training_loop(
    ...
    torch.backends.cuda.matmul.allow_tf32 = allow_tf32  # Improves training speed, reduces numerical accuracy.
    torch.backends.cudnn.allow_tf32 = allow_tf32        # Improves training speed, reduces numerical accuracy.
    ...
    if rank == 0:
        ...
        img = misc.print_module_summary(G, dict(z=z, c=c))
        misc.print_module_summary(D, dict(img=img, c=c))
    ...
    while True:
        ...
        for phase, phase_gen_z, phase_gen_c in zip(phases, all_gen_z, all_gen_c):
            ...
            if hasattr(phase.module, "feature_network") and phase.name in ['Dmain', 'Dboth', 'Dreg']:
